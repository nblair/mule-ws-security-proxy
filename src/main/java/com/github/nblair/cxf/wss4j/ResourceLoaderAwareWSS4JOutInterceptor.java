...
/**
 *  Custom extension of {@link WSS4JOutInterceptor} to allow for reading {@link Crypto} properties using the Spring
 ...
 * @author nblair
 */
public class ResourceLoaderAwareWSS4JOutInterceptor extends WSS4JOutInterceptor implements ResourceLoaderAware {
	 ...
	 * @param props
	 */
	public ResourceLoaderAwareWSS4JOutInterceptor(Map<String, Object> props) {
		super(props);
	}
	/**
